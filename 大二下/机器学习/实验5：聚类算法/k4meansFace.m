...
classColor=[[255 0 0];[0 255 0];[0 0 255];[255 0 255]];
class=zeros(1,k);
classCenter=[8000 2000;10000 5000;6000 -2000;5000 -800];
...
for i=1:sampleNumberAll
    ...
    elseif class(i)==3
        scatter(sample(i,1),sample(i,2),'b','h','filled');
    else
        scatter(sample(i,1),sample(i,2),'m','o','filled');
    end
    hold on;
    picture=pictures(:,i);
    ...
    colormap(gray(256));
    image('CData',picture,'XData',[sample(i,1)-300 sample(i,1)+300],'YData',[sample(i,2)-500+700 sample(i,2)+500+700]);
end